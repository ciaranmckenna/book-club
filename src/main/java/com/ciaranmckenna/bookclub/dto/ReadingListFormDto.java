...
/**
 * DTO for form binding when creating or editing reading lists This class is separate from the
 * business logic DTO to avoid validation conflicts during form display.
 */
