 ...
 * Captures exceptions and returns appropriate API responses
 * Only applied to controllers in the api package
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        return errorResponseEntity("Database constraint violation: " + ex.getMostSpecificCause().getMessage(), 
                HttpStatus.CONFLICT);
    }
