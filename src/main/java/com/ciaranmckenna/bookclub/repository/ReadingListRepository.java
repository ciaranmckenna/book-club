...
/**
 * Repository for ReadingList entity
 * Provides database operations for ReadingList entities
 */
@Repository
public interface ReadingListRepository extends JpaRepository<ReadingList, Long> {
     ...
     */
    Page<ReadingList> findByNameContainingIgnoreCaseAndUserId(String name, Long userId, Pageable pageable);
